...
class TwitterOAuth {
  ...
  public $http_info;
  /* Set the useragnet. */
  public $useragent = 'TwitterOAuth v0.2.0-beta3-aureq';
  ...
  function http($url, $method, $postfields = NULL) {
    ...
    if ($this->proxy_host && $this->proxy_port) {
        ...
        curl_setopt($ci, CURLOPT_PROXY, $this->proxy_host.':'.$this->proxy_port);
        if ($this->proxy_user && $this->proxy_pass) {
            curl_setopt($ci, CURLOPT_PROXYAUTH, CURLAUTH_BASIC);
            curl_setopt($ci, CURLOPT_PROXYUSERPWD, $this->proxy_user.':'.$this->proxy_pass);
        }
    }
